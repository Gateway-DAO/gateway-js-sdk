import { Sdk, createProof_mutationMutationVariables, proofsByPDAIds_queryQueryVariables, proofs_queryQueryVariables, receivedProofs_queryQueryVariables, sentProofsCount_queryQueryVariables, sentProofs_queryQueryVariables } from '../../.mesh';
export declare class Proof {
     ...
     * `sdk` object.
     */
    getProof(id: string): Promise<import("../../.mesh").proof_queryQuery>;
    /**
     ...
     * call.
     */
    createProof(inputVariables?: createProof_mutationMutationVariables): Promise<import("../../.mesh").createProof_mutationMutation>;
    /**
     ...
     */
    createProofMessage(requestId: string): Promise<import("../../.mesh").createProofMessage_mutationMutation>;
    /**
     ...
     */
    getProofs(variables?: proofs_queryQueryVariables): Promise<import("../../.mesh").proofs_queryQuery>;
    /**
     ...
     */
    getProofsByPDAIds({ pdaIds, skip, take, }: proofsByPDAIds_queryQueryVariables): Promise<import("../../.mesh").proofsByPDAIds_queryQuery>;
    /**
     ...
     */
    getReceivedProofs(variables?: receivedProofs_queryQueryVariables): Promise<import("../../.mesh").receivedProofs_queryQuery>;
    /**
     ...
     */
    getReceivedProofsCount(organizationId?: string): Promise<import("../../.mesh").receivedProofsCount_queryQuery>;
    /**
     ...
     */
    getSentProofs(variables?: sentProofs_queryQueryVariables): Promise<import("../../.mesh").sentProofs_queryQuery>;
    /**
     ...
     */
    getSentProofsCount(queryVariables?: sentProofsCount_queryQueryVariables): Promise<import("../../.mesh").sentProofsCount_queryQuery>;
}
