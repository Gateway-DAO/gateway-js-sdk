...
class Proof {
     ...
     */
    getProofsByPDAIds({ pdaIds, skip, take, }) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
     ...
     */
    getReceivedProofsCount(organizationId) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                if (organizationId) {
     ...
     */
    getSentProofsCount(queryVariables) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
