...
class Auth {
    ...
    checkUsernameAvailability(username) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                (0, validators_1.isStringValid)(username);
                return (yield this.sdk.checkUsernameAvailability_query({ username }))
    ...
    addEmail(email) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                return (yield this.sdk.addEmail_mutation({ input: { email } })).addEmail;
            }
            catch (error) {
                throw new Error((0, errorHandler_1.errorHandler)(error));
            }
     ...
     */
    addEmailConfirmation(email, code) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                (0, validators_1.isEmailValid)(email);
                return (yield this.sdk.addEmailConfirmation_mutation({
                    input: { code, email },
    ...
    addWallet(wallet, chain) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                (0, validators_1.isWalletAddressvalid)(wallet, chain);
                return (yield this.sdk.addWallet_mutation({ input: { wallet, chain } }))
                    .addWallet;
            }
            catch (error) {
                throw new Error((0, errorHandler_1.errorHandler)(error));
     ...
     */
    addWalletConfirmation(walletConfirmationInput) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                (0, validators_1.isStringValid)(walletConfirmationInput.signature);
                return yield this.sdk.addWalletConfirmation_mutation({
     ...
     */
    createWalletNonce(wallet, chain) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                (0, validators_1.isWalletAddressvalid)(wallet, chain);
                return (yield this.sdk.createWalletNonce_mutation({ input: { wallet, chain } })).createWalletNonce;
            }
            catch (error) {
                throw new Error((0, errorHandler_1.errorHandler)(error));
            }
    ...
    deleteAccount(id) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                return (yield this.sdk.deleteAccount_mutation({ id })).deleteAccount;
            }
            catch (error) {
                throw new Error((0, errorHandler_1.errorHandler)(error));
            }
    ...
    loginEmail(email, code) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                (0, validators_1.isEmailValid)(email);
                return (yield this.sdk.loginEmail_mutation({ input: { email, code } }))
                    .loginEmail;
            }
            catch (error) {
                throw new Error((0, errorHandler_1.errorHandler)(error));
     ...
     */
    loginWallet(wallet, chain, signature) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                (0, validators_1.isWalletAddressvalid)(wallet, chain);
                (0, validators_1.isStringValid)(signature);
                return (yield this.sdk.loginWallet_mutation({
    ...
    refreshToken(existingRefreshToken) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                (0, validators_1.isStringValid)(existingRefreshToken);
                return (yield this.sdk.refreshToken_mutation({
     ...
     */
    unregisterAuthMethod(data, type) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                (0, validators_1.isStringValid)(data);
                return yield this.sdk.unregisterAuthMethod_mutation({
                    input: { data, type },
                });
            }
            catch (error) {
